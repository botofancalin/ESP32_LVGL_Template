...
{
    xpt_conf_t xpt_conf = {
        .pin_num_cs = LVGL_TOUCH_CS_GPIO,   /*!<SPI Chip Select Pin*/
        .pin_num_irq = LVGL_TOUCH_IRQ_GPIO, /*!< Touch screen IRQ pin */
        .clk_freq = XPT2046_CLK_FREQ * 1000 * 1000,               /*!< spi clock frequency */
        .spi_host = (spi_host_device_t)LVGL_LCD_SPI,                     /*!< spi host index */
